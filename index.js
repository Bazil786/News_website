...
// Apis Section
const API_Key = '86fdd4c5e12b4b0e90b39f03193c5b76';
...
searchBtn.addEventListener('click', function () {
  newsType.innerHTML = '<h4>Search :</h4>';
  fetchQueryNews();
});

// Function for general news
...
function displayNews() {
  ...
  if (newsDataArr.length == 0) {
    newsdetails.innerHTML = '<h2> No data found.</h5>';
    return;
  }
  ...
  newsDataArr.forEach((news) => {
    ...
    col.className = 'col-sm-12 col-md-5 col-lg-5 p-2';
